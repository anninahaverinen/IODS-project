...
# Logisitic regression and cross validationn
...
ORCImodel1 
``` 
The residuals are more or less normally distribiuted and the median is close to 0. The coeffients for the variables all show statistical significance in the model. This means these are highly predictive variables of being judged to have high alcohol use. 
...
g
``` 
In this picture we see the same thing, the observations plotted the probability and prediction by high_use.
